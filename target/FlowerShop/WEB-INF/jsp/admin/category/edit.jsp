...
<div class="admin-biaogelist">
    <div class="listbiaoti am-cf">
        ...
        <dl class="am-icon-home" style="float: right;">当前位置： 首页 ><a href="#">一级列表</a></dl>
    </div>

    <form id="userAction_save_do" name="Form1" class="am-form am-g"
          action="${pageContext.request.contextPath}/admin/adminCategoryController/edit.action" method="post">
        <input type="hidden" name="cid" value="${category.cid }"/>
            ...
            <div class="am-g am-margin-top-sm">
                ...
                <div class="am-u-sm-8 am-u-md-4 am-u-end">
                    <input type="text" name="cname" class="am-input-sm" value="${category.cname}"/>
                </div>
            </div>
